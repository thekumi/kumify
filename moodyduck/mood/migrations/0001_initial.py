...
import moodyduck.common.helpers
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "aspect",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mood.aspect"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "activity",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mood.activity"
                    ),
                ),
                (
                    "status",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="mood.status"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        upload_to="",
                        verbose_name=moodyduck.common.helpers.get_upload_path,
                    ),
                ),
                (
                    "status",
